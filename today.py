...
USER_NAME = os.environ['USER_NAME'] # 'Gabriel-Buchud'
...
if __name__ == '__main__':
    ...
    # e.g {'id': '#144957354'} and 2019-11-03T21:15:07Z for username 'Gabrie-buchud'
    ...
    if OWNER_ID == {'id': '#144957354'}: # only calculate for user Gabriel-Buchud
